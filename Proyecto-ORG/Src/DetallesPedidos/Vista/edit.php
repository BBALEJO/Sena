...
<body>
    ...
    <form class="contenedor contenido" action="">
        ...
        <input disabled="disabled" type="number" value="0"><br>
        <label for="">Valor del producto</label><br>
        <input disabled="disabled" type="number" min="1" placeholder="ingrese el valor unitario"><br>
        <label for="">Valor total</label><br>
        <input disabled="disabled" type="number" name="" id="" placeholder="valor total" min="1"><br>
